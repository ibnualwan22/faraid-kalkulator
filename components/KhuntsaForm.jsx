...
export default function KhuntsaForm({ selectedHeirs, onCalculate, isLoading }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!khuntsaKey) { 
            setError('Pilih siapa ahli waris yang Khuntsa.'); 
            return; 
        }
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="bg-emerald-600 px-6 py-5">
                ...
                <p className="text-emerald-100 text-sm mt-1">Masukkan detail ahli waris khuntsa dan jumlah harta waris</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                    <label className="block text-sm font-bold text-gray-800 mb-3">
                        ...
                        Pilih Ahli Waris yang Khuntsa
                    </label>
                    <select 
                        value={khuntsaKey} 
                        onChange={(e) => setKhuntsaKey(e.target.value)} 
