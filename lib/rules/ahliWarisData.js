   ...
   'anak_lk': {
    ...
    'saudara_lk_kandung': {
        ...
        conditions: [
            ...
            { 
                bagian: 'mahjub', 
                syarat: "Terhalang oleh Ushul lk (Ayah/Kakek) atau Furu' lk (Anak/Cucu lk).", 
                check: (state) => state.hasUshulLaki() || state.hasFuruLaki() 
            },
    ...
    'saudara_lk_seibu': {
        ...
        category: 'Saudara',
        conditions: [
            { bagian: 'mahjub', syarat: "Terhalang oleh Ushul lk atau Furu'.", check: (state) => state.hasUshulLaki() || state.hasFuru() },
            { bagian: 'musytarakah', syarat: "Menjadi ahli waris Musytarakah, berbagi 1/3 dengan Saudara Kandung.", check: (state) => state.isMusytarakah },
...
{ 
    ...
    'saudari_kandung': {
        ...
        category: 'Saudara',
        conditions: [
            { bagian: 'mahjub', syarat: "Terhalang oleh Ushul lk atau Furu' lk.", check: (state) => state.hasUshulLaki() || state.hasFuruLaki() },
            { bagian: 'ashabah_bilghair', syarat: "Menjadi Ashabah بالغير karena bersama Saudara Lk Kandung.", check: (state) => state.has('saudara_lk_kandung') },
