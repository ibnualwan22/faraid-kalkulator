...
export const ahliWarisData = {
   ...
   'anak_lk': {
    ...
    'kakek': {
        name: 'Kakek (dari Ayah)', nameAr: '(أب الأب) جدّ', gender: 'L', type: 'dzawil_furudh_ashabah',
        category: 'Orang Tua',
        conditions: [
   ...
   'saudara_lk_seayah': {
    ...
    conditions: [
        ...
        // --- PERBAIKAN DI SINI ---
        // Logika check dibuat lebih eksplisit dan mandiri
        { 
            bagian: 'mahjub', 
            syarat: "Terhalang oleh Saudari Kandung yang menjadi Ashabah ma'al ghair (karena ada Furu' perempuan).", 
            check: (state) => 
                state.has('saudari_kandung') &&       // Jika ada Saudari Kandung
                !state.has('saudara_lk_kandung') &&   // dan TIDAK ada Saudara Lk Kandung (yang akan membuatnya jadi 'ashabah bil ghair)
                state.hasFuruPerempuan()              // dan ADA Furu' perempuan di dalam state INI.
        },
        // -------------------------
    ...
    'saudara_lk_seibu': {
        ...
        category: 'Saudara',
        conditions: [
            { bagian: 'mahjub', syarat: "Terhalang oleh Ayah, Furu' lk", check: (state) => state.has('ayah') || state.hasFuruLaki()  },
...
{ 
    ...
    'nenek_dari_ibu': {
        name: 'Nenek (dari Ibu)', nameAr: 'جدّة لأم (أم الأم)', gender: 'P', type: 'dzawil_furudh',
        category: 'Orang Tua',
        conditions: [
    ...
    'nenek_dari_ayah': {
        name: 'Nenek (dari Ayah)', nameAr: 'جدّة لأب (أم الأب)', gender: 'P', type: 'dzawil_furudh',
        category: 'Orang Tua',
        conditions: [
    ...
    'saudari_kandung': {
        name: 'Saudari Kandung', nameAr: 'أخت لأبوين', gender: 'P', type: 'dzawil_furudh',
        category: 'Saudara',
        conditions: [
