// app/kasus-khusus/mafqud/page.js
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8">
                    <div className="bg-emerald-600 px-6 py-5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-white">Kalkulator Waris Mafqud (المفقود)</h1>
                                <p className="text-emerald-100 text-sm mt-1">Perhitungan warisan jika salah satu ahli waris hilang dan tidak diketahui nasibnya</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-blue-50 border-t border-blue-200 px-6 py-4">
                        <div className="flex gap-3">
                            ...
                            <div>
                                <h4 className="font-bold text-blue-900 mb-1">Tentang Mafqud</h4>
                                <p className="text-sm text-blue-800">
                                    Mafqud adalah ahli waris yang hilang dan tidak diketahui nasibnya. Sistem akan menghitung dua skenario (dianggap hidup dan dianggap wafat) untuk menentukan bagian yang paling adil bagi semua ahli waris.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                                ...
                                <p className="text-sm text-gray-600 mt-1">Pilih semua ahli waris termasuk yang hilang (Mafqud)</p>
                            </div>
                            <div className="p-6">
                                <HeirSelector 
                                    heirs={heirs} 
                ...
                {step === 3 && result && (
                    <div id="result-section" className="space-y-6">
                        ...
                        <MafqudResultDisplay result={result} />
                    </div>
                )}
            </div>
        </div>
