// app/kasus-khusus/khuntsa/page.js

'use client';
import { useState, useEffect } from 'react';
import HeirSelector from '@/components/HeirSelector';
import KhuntsaForm from '@/components/KhuntsaForm';
import KhuntsaResultDisplay from '@/components/KhuntsaResultDisplay';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8">
          <div className="bg-emerald-600 px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Kalkulator Waris Khuntsa (الخنثى)</h1>
                <p className="text-emerald-100 text-sm mt-1">Perhitungan warisan dengan ahli waris yang memiliki jenis kelamin tidak pasti</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border-t border-blue-200 px-6 py-4">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-bold text-blue-900 mb-1">Tentang Khuntsa</h4>
                <p className="text-sm text-blue-800">
                  Khuntsa adalah ahli waris yang memiliki jenis kelamin tidak pasti atau ambigu. Sistem akan menghitung dua skenario (sebagai laki-laki dan perempuan) untuk menentukan bagian yang paling adil.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                  ...
                  Langkah 1: Pilih Ahli Waris
                </h2>
                <p className="text-sm text-gray-600 mt-1">Pilih semua ahli waris termasuk yang memiliki jenis kelamin tidak pasti (Khuntsa)</p>
              </div>
              <div className="p-6">
                <HeirSelector 
                  heirs={heirs} 
        ...
        {step === 3 && result && (
          <div id="result-section" className="space-y-6">
            ...
            <KhuntsaResultDisplay result={result} />
          </div>
        )}
      </div>
    </div>
